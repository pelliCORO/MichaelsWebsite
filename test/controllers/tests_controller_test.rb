...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { email: @test.email, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { email: @test.email, password: 'secret', password_confirmation: 'secret' } }
